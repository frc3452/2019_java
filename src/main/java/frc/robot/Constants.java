...
public class Constants {
    ...
    public static final boolean USE_PATH_ADAPTER = false;
...
//        System.out.println(new ReflectingClassReader<kElevator.Heights>(kElevator.Heights.class, kElevator.Heights.Cargo_1));
//    }
