...
public class GZJoystick extends Joystick {
    ...
    public void altRumble(int numberOfRumbles, double numberOfSeconds) {
        double rumblesPerSecond = 0.0;

        //3 rumbles in half a second
//		(3,.5)
//		rumblesPerSecond = (1/numberOfSeconds) * 3
        // 6


        if (numberOfSeconds != 0) {
            rumblesPerSecond = (1.0 / numberOfSeconds) * numberOfRumbles;
        }
