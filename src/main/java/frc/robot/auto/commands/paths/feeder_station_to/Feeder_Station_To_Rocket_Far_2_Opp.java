...
public class Feeder_Station_To_Rocket_Far_2_Opp extends PathContainer {
    public Feeder_Station_To_Rocket_Far_2_Opp() {
        ...
        sWaypoints.add(new Waypoint(289.866, 42.992, 15, 60));
        sWaypoints.add(new Waypoint(275.3280759396338, 35.01586158188823, 1, 30));
        sWaypoints.add(new Waypoint(260.79, 27.04, 0, 30));
    }
