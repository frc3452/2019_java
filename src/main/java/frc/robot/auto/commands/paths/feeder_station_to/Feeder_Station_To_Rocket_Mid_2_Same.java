...
public class Feeder_Station_To_Rocket_Mid_2_Same extends PathContainer {
    public Feeder_Station_To_Rocket_Mid_2_Same() {
        ...
        sWaypoints.add(new Waypoint(229.28, 251.896, 0, 60).setFieldAdaption(PathAdapter.rocketMid));
        sWaypoints.add(new Waypoint(229.28, 264.478, 0, 30).setFieldAdaption(PathAdapter.rocketMid));
