...
public class Left_Rocket_Mid_Same extends PathContainer {
    public Left_Rocket_Mid_Same() {
        ...
        sWaypoints.add(new Waypoint(229.28, 223.677, 15, 60).setFieldAdaption(PathAdapter.rocketMid));
        sWaypoints.add(new Waypoint(229.28, 250.86849999999998, 1, 60).setFieldAdaption(PathAdapter.rocketMid));
