...
public class Center_Rocket_Mid_Left extends PathContainer {
    public Center_Rocket_Mid_Left() {
        ...
        sWaypoints.add(new Waypoint(229.28, 250.961, 15, 60).setFieldAdaption(PathAdapter.rocketMid));
        sWaypoints.add(new Waypoint(229.28, 267.0105, 1, 30).setFieldAdaption(PathAdapter.rocketMid));
