...
public class Bay_2_Turn_Around_Same extends PathContainer {
    public Bay_2_Turn_Around_Same() {
        this.sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(282.5, 225.37, 0, 0));
        sWaypoints.add(new Waypoint(282.5, 249, 15, 60));
