...
public class Feeder_Station_To_Rocket_Mid_1_Opp extends PathContainer {
    public Feeder_Station_To_Rocket_Mid_1_Opp() {
        ...
        sWaypoints.add(new Waypoint(210, 101, 15, 60));
        sWaypoints.add(new Waypoint(254, 101, 1, 60));
        sWaypoints.add(new Waypoint(278, 101, 0, 60));
    }
