...
public class Feeder_Station_To_Rocket_Close_2_Same extends PathContainer {
    public Feeder_Station_To_Rocket_Close_2_Same() {
        ...
        sWaypoints.add(new Waypoint(148.89, 270.308, 15, 60).setFieldAdaption(PathAdapter.rocketNear));
        sWaypoints.add(new Waypoint(173.17997905314655, 283.6340381810009, 1, 30).setFieldAdaption(PathAdapter.rocketNear));
