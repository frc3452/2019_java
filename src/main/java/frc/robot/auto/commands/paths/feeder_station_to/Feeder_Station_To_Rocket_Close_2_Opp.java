...
public class Feeder_Station_To_Rocket_Close_2_Opp extends PathContainer {
    public Feeder_Station_To_Rocket_Close_2_Opp() {
        ...
        sWaypoints.add(new Waypoint(167, 43, 15, 60));
        sWaypoints.add(new Waypoint(185.9990869109826, 33.33315842039668, 0, 30));
        sWaypoints.add(new Waypoint(197.47, 27.04, 0, 30));
    }
