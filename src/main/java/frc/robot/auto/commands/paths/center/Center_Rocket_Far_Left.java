...
public class Center_Rocket_Far_Left extends PathContainer {
    public Center_Rocket_Far_Left() {
        ...
        sWaypoints.add(new Waypoint(289.973, 280.95, 15, 60).setFieldAdaption(PathAdapter.rocketFar));
        sWaypoints.add(new Waypoint(275.3814278800546, 288.95486854129393, 1, 30).setFieldAdaption(PathAdapter.rocketFar));
