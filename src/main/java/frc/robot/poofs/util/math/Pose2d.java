...
public class Pose2d implements IPose2d<Pose2d> {
    ...
    public Pose2d(final Translation2d translation) {
        this(translation, new Rotation2d());
    }

    public Pose2d(final Rotation2d rotation) {
        this(new Translation2d(), rotation);
    }

    public Pose2d(Pose2d pose, final Rotation2d rotation) {
        this(pose.getTranslation(), rotation);
    }

    public Pose2d(double theta_degrees) {
    ...
    public boolean equals(final Object other) {
        if (other == null || !(other instanceof Pose2d))
            return false;
        return epsilonEquals((Pose2d) other, GZUtil.kEpsilon);
    }
